...
const socialMedia = [
	{
		name: "LinkedIn",
		href: "https://www.linkedin.com/in/tristan-jay-amit-9a3ba51b8",
		icon: (
	...
	{
		name: "Instagram",
		href: "https://www.instagram.com/tjayamit",
		icon: (
			<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
	...
	{
		name: "Gmail",
		href: "https://mail.google.com/mail/?view=cm&fs=1&to=tristanjayamit0813@gmail.com&su=Hello from Portfolio&body=Hi Tristan,",
		icon: (
			<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
		...
		<div className={className}>
			{socialMedia.map((item) => (
				<a
					...
					className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors cursor-pointer"
				>
					{item.icon}
				</a>
			))}
